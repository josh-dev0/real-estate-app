...
export const RegisterForm: React.FC<RegisterFormProps> = ({
  ...
  return (
    <div className={classNames("bg-primary px-12 py-10", className)}>
      <p className="text-center text-bg-secondary-dark text-lg leading-[22px]">New here?</p>
      <NonFormItem>
        <ul className="text-bg-secondary-dark text-[11px] leading-2xl list-disc mt-8 pl-3">
      ...
      >
        ...
        <NonFormItem className="pl-4 text-xs leading-[22px] text-primary -mt-3">
        ...
        <Form.Item
          className="mt-7"
          name={['user', 'email']} label="Been referred?" rules={[{ type: 'email' }]}>
          <Input
            className="text-2xs leading-[22px]"
            placeholder="Enter your referral key here"
          />
        </Form.Item>
        <NonFormItem className="text-2xs leading-[22px] text-icon-1">
